...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onResume() {
        ...
        String sync = sharedpreferences.getString("sync", "");
        Log.d("", sync);
 ...
 /*   private void downloadData() {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navWipeData) {
            ...
            ActivityStarter.startActivity(this, ImagesActivity.getIntent(this), false);
        }else if (id == R.id.logs) {
            ActivityStarter.startActivity(this, LogsActivity.getIntent(this), false);
        }else if (id == R.id.fire) {
            ActivityStarter.startActivity(this, ScreenfireActivity.getIntent(this), false);
